...
def upgrade() -> None:
    ...
    op.alter_column('run', 'total_distance',
               existing_type=sa.DOUBLE_PRECISION(precision=53),
               nullable=True)
    op.alter_column('run', 'path_identifier',
...
def downgrade() -> None:
    ...
    sa.Column('identifier', sa.UUID(), autoincrement=False, nullable=False),
    sa.Column('user_identifier', sa.UUID(), autoincrement=False, nullable=False),
    sa.Column('crew_identifier', sa.UUID(), autoincrement=False, nullable=False),
    sa.Column('joined_at', postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=False),
    sa.Column('role', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.Column('is_deleted', sa.BOOLEAN(), autoincrement=False, nullable=False),
    sa.Column('member_status', sa.VARCHAR(), autoincrement=False, nullable=False),
    sa.Column('version_uuid', sa.UUID(), autoincrement=False, nullable=False),
    sa.ForeignKeyConstraint(['crew_identifier'], ['crew.identifier'], name='crew_member_crew_identifier_fkey'),
    sa.ForeignKeyConstraint(['user_identifier'], ['user.identifier'], name='crew_member_user_identifier_fkey'),
    sa.PrimaryKeyConstraint('identifier', name='crew_member_pkey')
    )
    ...
    sa.Column('version_uuid', sa.UUID(), autoincrement=False, nullable=False),
    sa.PrimaryKeyConstraint('identifier', name='crew_pkey')
    )
